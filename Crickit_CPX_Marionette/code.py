...
BUTTON_2 = crickit.SIGNAL2  # button #2 connected to signal port 3 & ground
BUTTON_3 = crickit.SIGNAL3  # button #3 connected to signal port 5 & ground
BUTTON_4 = crickit.SIGNAL4  # button #4 connected to signal port 7 & ground
